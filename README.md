...
5. `Storeprocedure.sql` (Tạo các thủ tục lưu trữ xử lý nghiệp vụ)
6. `encrypted.sql` (Thiết lập cấu hình và function mã hóa dữ liệu)
7. `Trigger.sql` (Tạo các Trigger bắt sự kiện thay đổi dữ liệu)
